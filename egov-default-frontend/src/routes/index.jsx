...
import RiderEdit from 'pages/riderManagement/RiderEdit';
...
const SecondRoutes = () => {
  ...
  return (
    <>
      <EgovHeader />
      <Routes>
          <Route path="/orderManagement/orders" element={<OrderList />} />
          <Route path="/orderManagement/OrderEdit" element={<OrderEdit />} />
          <Route path="/orderManagement/OrderDetail" element={<OrderDetail />} />

          <Route path="/riderManagement/riders" element={<RiderList />} />
          <Route path="/riderManagement/RiderEdit" element={<RiderEdit />} />
          <Route path="/riderManagement/RiderDetail" element={<RiderDetail />} />
